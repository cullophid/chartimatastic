...
var renderLineChart = function renderLineChart(x, fields, series, data) {
  return _react2.default.createElement(
    _recharts.LineChart,
    { data: data, margin: { right: 100, top: 40, bottom: 40 } },
    ...
    series.map(function (s, i) {
      return _react2.default.createElement(_recharts.Line, { key: i, type: 'monotone', dataKey: s, stroke: color(i) });
    })
  );
};

var renderAreaChart = function renderAreaChart(x, fields, series, data) {
  return _react2.default.createElement(
    _recharts.AreaChart,
    { data: data, margin: { right: 100, top: 40, bottom: 40 } },
    _react2.default.createElement(_recharts.Tooltip, null),
    ...
    _react2.default.createElement(_recharts.YAxis, { label: fields[1], tickLine: false, stroke: '#aaa' }),
    series.map(function (s, i) {
      return _react2.default.createElement(_recharts.Area, { key: i, type: 'monotone', dataKey: s, stroke: color(i) });
    })
  );
};
...
exports.default = (0, _lazy2.default)(function (props) {
  ...
  return _react2.default.createElement(
    ...
    props.area ? renderAreaChart(x, fields, series, chartData) : renderLineChart(x, fields, series, chartData)
  );
});